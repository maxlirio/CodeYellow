...
export const NAME_PREFIX = {
  common: ['Surplus', 'Salvaged', 'Stock', 'Grey-Market'],
  fine: ['Milspec', 'Vector', 'Calibrated', 'Tuned'],
  rare: ['Overclocked', 'Prototype', 'Blacksite', 'Hotwired'],
  epic: ['Phaselock', 'Singularity', 'Antimatter', 'Voidwrought'],
  legendary: ['Omega', 'Apex', 'Zero-Day', 'Dreadnought'],
};
export const NAME_SUFFIX = ['', '', ' Mk II', ' Mk III', ' Mk V', ' Mk VII', ' X-9', ' [REDLINE]'];
export const TRINKET_NAMES = ['Implant', 'Chip', 'Module', 'Coprocessor', 'Uplink'];
...
export const ENEMIES = {
  ...
  berserker:{ name: 'Feral Husk', model: 'Character_Enemy', animMap: 'troop', show: ['Knife_2'], hp: 44, dmg: 11, speed: 5.6, range: 2.2, xp: 36, gold: [8, 16], attackTime: 0.55, aggro: 14, scale: 0.85, tint: 0xffb4a4, enrage: true },
  ...
  plaguebearer:{ name: 'Blight Drifter', model: 'Cyber_Enemy_Flying_Gun', animMap: 'cyberfly', hp: 38, dmg: 8, speed: 4.4, range: 2.2, xp: 38, gold: [9, 17], attackTime: 0.95, aggro: 12, scale: 1.35, fly: true, tint: 0xc0f0b0, plague: { dps: 4, dur: 4 }, deathCloud: 3.2 },
  ...
  slime:    { name: 'Nanite Mass', model: 'RobotExpressive', animMap: 'robot', hp: 40, dmg: 8, speed: 3.4, range: 2.0, xp: 24, gold: [5, 10], attackTime: 1.0, aggro: 11, scale: 0.5, paint: 0x35e8d8, splitInto: 'slimelet' },
  ...
  skitter:  { name: 'Skitterling', model: 'Enemy_Small', animMap: 'void', hp: 30, dmg: 9, speed: 6.8, range: 2.2, xp: 18, gold: [3, 8], attackTime: 0.75, aggro: 14, scale: 1.6, fly: true, hoverY: 0.6, chitin: true },
  spitter:  { name: 'Bile Spitter', model: 'Enemy_Flying', animMap: 'void', hp: 44, dmg: 12, speed: 4.6, range: 13, xp: 34, gold: [7, 14], attackTime: 1.4, aggro: 15, scale: 1.9, fly: true, ranged: true, boltVis: 'bio', boltColor: 0x8aff5c, boltSpeed: 21, muzzleY: 1.4, chitin: true },
  broodguard:{ name: 'Broodguard', model: 'Enemy_Large', animMap: 'husk', hp: 120, dmg: 20, speed: 4.4, range: 2.8, xp: 60, gold: [14, 26], attackTime: 1.15, aggro: 13, scale: 2.0, kbHit: 8, stalwart: true, chitin: true },
  ...
  broodmind:{ name: 'The Broodmind', model: 'Enemy_Large', animMap: 'husk', hp: 950, dmg: 26, speed: 4.8, range: 4.0, xp: 620, gold: [220, 320], attackTime: 1.05, aggro: 26, scale: 4.2, boss: true, broodmind: true, stalwart: true, kbHit: 11, tint: 0xb08cff, summons: true, summonEvery: 7, summonType: 'skitter', summonCount: 2, bossName: 'THE BROODMIND', bossMsg: 'shrieks the hive awake', chitin: true },
