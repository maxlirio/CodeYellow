...
function spellDetail(sp, dmg, p) {
  ...
  switch (sp.type) {
    ...
    case 'lash': bits.push(`turns YOUR gravity toward the aimed surface (${sp.range}u) — you fall onto it and walk it; mana never regenerates while the world is turned, and re-lashing surface-to-surface is free of cooldown`); break;
